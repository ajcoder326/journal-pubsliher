        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    @if(!empty($siteSettings['footer_logo']))
                        <img src="{{ asset('storage/' . $siteSettings['footer_logo']) }}" alt="" style="max-height: 270px; margin-top: -10px;" class="me-2">
                    @elseif(!empty($siteSettings['site_logo']))
                        <img src="{{ asset('storage/' . $siteSettings['site_logo']) }}" alt="" style="max-height: 270px; margin-top: -10px;" class="me-2">
                    @endif
                </div>
