...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $admin = User::create([
            "name" => "Admin User",
            "email" => "admin@dejournal.com",
            "password" => Hash::make("password123"),
            "role" => "admin",
            "affiliation" => "DE-Journal Administration",
        ]);

        User::create([
            "name" => "Dr. John Smith",
            "email" => "editor@dejournal.com",
            "password" => Hash::make("password123"),
            "role" => "editor",
        ...
        $volume1 = Volume::create([
            "title" => "DE-Journal Volume 1",
            "description" => "Inaugural issue of DE-Journal featuring groundbreaking research.",
            "year" => 2024,
            "issue_number" => 1,
            "status" => "published",
        ...
        Post::create([
            ...
            "slug" => "welcome-to-dejournal",
            "content" => "<p>We are excited to announce the launch of DE-Journal, a peer-reviewed academic journal dedicated to publishing high-quality research across various disciplines.</p><p>Our mission is to provide a platform for researchers worldwide to share their findings and contribute to the advancement of knowledge.</p>",
            "status" => "published",
        ...
        Post::create([
            ...
            "content" => "<p>We are now accepting submissions for Volume 3 of DE-Journal. Submit your research papers for peer review.</p><p>Deadline: March 31, 2026</p>",
            "status" => "published",
        ...
        // Settings
        Setting::create(["key" => "site_name", "value" => "DE-Journal"]);
        Setting::create(["key" => "site_email", "value" => "info@dejournal.com"]);
        ...
        EmailTemplate::create([
            ...
            "body" => "<h2>Paper Submission Confirmation</h2><p>Dear {author_name},</p><p>Your paper <strong>{paper_title}</strong> has been successfully submitted to DE-Journal.</p><p><strong>Authors:</strong> {authors}<br><strong>Submitted:</strong> {submitted_date}</p><p>Our editorial team will review your submission and you will be notified of any updates.</p><p>You can track your submission status in your <a href=\"{dashboard_url}\">Dashboard</a>.</p><p>Thank you for choosing DE-Journal.</p><p>Best regards,<br>DE-Journal Editorial Team</p>",
        ...
        EmailTemplate::create([
            ...
            "body" => "<h2>Review Request</h2><p>Dear {reviewer_name},</p><p>You have been assigned to review the following paper:</p><p><strong>Title:</strong> {paper_title}<br><strong>Authors:</strong> {authors}<br><strong>Keywords:</strong> {keywords}</p><p><strong>Abstract:</strong></p><p>{abstract}</p><p><a href=\"{review_url}\">Access the paper for review</a></p><p>Please complete your review within 21 days.</p><p>Best regards,<br>DE-Journal Editorial Team</p>",
